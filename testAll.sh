...
if test -z "$TESTS"; then
    ...
    tests=(DNS+Mail+WEB OSPF BGP DHCP6+RSOL RIP DHCP Ping Traceroute services ipsec44 ipsec46 ipsec64 ipsec66 functional_tests/rj45 functional_tests/rj45_vlan functional_tests/extelem functional_tests/empty_ifaces)
